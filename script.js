...
function goBackToWelcome() {
    ...
    // Save player progress to localStorage, including the score
    localStorage.setItem(playerName, JSON.stringify({
        level: currentLevel,
        score: score,  // Save the player's current score
        lastLevel: currentLevel  // Optionally, save the last level reached
    }));
    ...
    congratsScreen.style.display = "none";
    const leaderboardScreen = document.getElementById('leaderboard-screen');
    leaderboardScreen.style.display = "none"; // Hide the leaderboard screen

    console.log('Leaderboard screen hidden');
